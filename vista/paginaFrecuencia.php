<?php
	...
	if (isset($_POST['txtValor'])) $valor = $_POST['txtValor'];

  
	switch ($boton) {
		case 'Guardar':
			$objFrecuencia = new Frecuencia($id, $valor);
			$objControlFrecuencia = new ControlFrecuencia($objFrecuencia);
			$objControlFrecuencia->guardar();
			header('Location: paginaFrecuencia.php');
			break;
		case 'Consultar':
			$objFrecuencia = new Frecuencia($id, $valor);
			$objControlFrecuencia = new ControlFrecuencia($objFrecuencia);
			$objFrecuencia = $objControlFrecuencia->consultar();
			$valor = $objFrecuencia->getValor();
			break;
		case 'Modificar':
			$objFrecuencia = new Frecuencia($id, $valor);
			$objControlFrecuencia = new ControlFrecuencia($objFrecuencia);
			...
			break;
		case 'Borrar':
			$objFrecuencia = new Frecuencia($id, null);
			$objControlFrecuencia = new ControlFrecuencia($objFrecuencia);
            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                        <div class="col-sm-6 mt-3 float-left" style="text-align: left"><h2><b>Frecuencias</b></h2></div>
                            <div class="col-sm-6" style="text-align: right;">
						            <a href="#crudModal" class="btn btn-outline-info mt-4" style="width:max-content" data-toggle="modal"><i class="fa fa-cog"></i> Administrar frecuencias</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <tr>
                        ...
                        <td><?php echo $arregloFrecuencia[$i]->getValor();?></td>
      ...
      <div class="me-md-auto text-center text-md-start">
        ...
        <div id="crudModal" class="modal fade">
                <div class="modal-dialog">
                    ...
                    <form action="paginaFrecuencia.php" method="post">
                        ...
                        <div class="form-group">
                            <label>Valor</label>
                            <input type="text" id="txtValor" name="txtValor" class="form-control" value="<?php echo $valor ?>">
                        </div>
                        <div class="form-group">
